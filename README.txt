...
Takes parameters -f (must be a pdf) 
		 -w outupt file to write to
...
May expand (upon need) to search for other types of information Perhaps search through other types of files, not just pdf
